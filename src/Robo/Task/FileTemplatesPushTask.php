 ...
 */
class FileTemplatesPushTask extends TaskBase
{
    ...
    protected function runAction(): static
    {
        ...
        /** @var \Sweetchuck\WebIdeConfigManager\Component\FileTemplate\Handler $handler */
        $handler = $this->getContainer()->get('app.fileTemplate.handler');
